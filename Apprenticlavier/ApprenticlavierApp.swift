...
private final class SparkleUpdaterDelegate:
    ...
    func feedURLString(
        ...
        "https://raw.githubusercontent.com/Orel3713/Apprenti-Clavier/main/appcast.xml"
    }
}
...
@MainActor
private final class StatistiquesWindowDelegate: NSObject, NSWindowDelegate {
...
final class GestionnaireFenetresAuxiliaires {
    ...
    private let delegueFenetreStatistiques = StatistiquesWindowDelegate()
    ...
    func ouvrirStatistiques() {
        ...
        fenetre.isReleasedWhenClosed = false
        fenetre.isRestorable = false
        fenetre.delegate = delegueFenetreStatistiques
        fenetre.center()
...
struct ApprenticlavierApp: App {
    ...
    @StateObject private var formateurs =
    ...
    var body: some Scene {
        ...
        .commands {
            CommandGroup(replacing: .appInfo) {
                Button("À propos d’Apprenti Clavier") {
                    GestionnaireFenetresAuxiliaires
                        .shared
                        .ouvrirAPropos()
                }
            ...
            CommandMenu("Apprenant") {
                ...
                Button("Changer d’apprenant…") {
                    NotificationCenter.default.post(
                        name: .changerApprenant,
                        object: nil
                    )
                }
                .disabled(
            ...
            CommandMenu("Contact") {
                Button("Signaler un problème…") {
                    ouvrirCourrielDeContact(
                        objet: "Problème dans Apprenti Clavier 2.0",
                        message:
                            "Bonjour,\n\n"
                            + "Je souhaite signaler un problème "
                            + "dans Apprenti Clavier 2.0.\n\n"
                            + "Description :\n\n"
                            + "Version de macOS :\n\n"
                ...
                Button("Proposer une amélioration…") {
                    ouvrirCourrielDeContact(
                        objet: "Suggestion pour Apprenti Clavier 2.0",
                        message:
                            "Bonjour,\n\n"
                            + "Je souhaite proposer une amélioration "
                            + "pour Apprenti Clavier 2.0.\n\n"
                            + "Suggestion :\n"
                    )
                }
            }
                ...
                NSWorkspace.shared
                    ...
                    afficherAlerte(
                        ...
                        message:
                            ...
                            + "a été exporté dans le dossier Téléchargements. "
                ...
                do {
                    ...
                    afficherAlerte(
                        ...
                        message:
                            ...
                            + "a bien été importé. Il est désormais disponible "
                            + "dans la liste située sous l’en-tête Choisissez un "
                            + "apprenant de l’écran d’accueil. "
                            + "Appuyez sur Entrée pour fermer cette fenêtre."
                    )
                } catch {
                    afficherAlerte(
